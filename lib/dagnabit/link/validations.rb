module Dagnabit
  module Link
    ...
    # the only basic requirement for a link is that it have a start point and an
    # end point.  We validate the presence of the +ancestor+ and +descendant+,
    # instead of +ancestor_id+ and +descendant_id+ in order to permit scenarios
    # like this:
    #
    #   n1 = Node.new
    #   n2 = Node.new
